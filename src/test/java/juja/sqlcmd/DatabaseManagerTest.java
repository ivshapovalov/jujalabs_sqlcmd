...
public class DatabaseManagerTest {
    ...
    private static final String TEST_DB_USER = "sqlcmd";
    private static final String TEST_DB_USER_PASSWORD = "sqlcmd";
    ...
    public static void setConnection() throws SQLException {
        connection = DriverManager.getConnection(DB_CONNECTION_URL + ADMIN_DB_NAME, ADMIN_USER, ADMIN_PASSWORD);
        executeSqlQuery("DROP DATABASE IF EXISTS " + TEST_DB_NAME);
        executeSqlQuery("CREATE DATABASE " + TEST_DB_NAME+" OWNER ="+ TEST_DB_USER);
        connection.close();
        connection = DriverManager.getConnection(DB_CONNECTION_URL + TEST_DB_NAME, ADMIN_USER, ADMIN_PASSWORD);
//        executeSqlQuery("ALTER SCHEMA public OWNER TO " + TEST_DB_USER);
        executeSqlQuery("DROP SCHEMA IF EXISTS public CASCADE");
        executeSqlQuery("CREATE SCHEMA public AUTHORIZATION " + TEST_DB_USER);
        connection.close();
        connection = DriverManager.getConnection(DB_CONNECTION_URL + TEST_DB_NAME, TEST_DB_USER, TEST_DB_USER_PASSWORD);
    }
    ...
    private static void dropSchema() throws SQLException {
        executeSqlQuery("DROP SCHEMA IF EXISTS public CASCADE");
        executeSqlQuery("CREATE SCHEMA IF NOT EXISTS public");
    }
//
...
//    }
    ...
    public void getTableNamesWhenNoTablesInDbReturnsEmptyArray() throws SQLException {
        databaseManager.connect(TEST_DB_NAME, TEST_DB_USER, TEST_DB_USER_PASSWORD);
